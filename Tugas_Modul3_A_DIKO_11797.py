...
st.markdown("<h1 style='text-align: center; color: #4CAF50;'>Prediksi IPK - 1797</h1>", unsafe_allow_html=True)
...
if uploaded_file is not None:
    ...
    model_directory = r'D:\Tugas3_A_11797'
    ...
    if os.path.exists(model_path):
        ...
        mtk4 = st.sidebar.number_input("Nilai Matematika Semester 2.2", 68.0, 100.0)
        ...
        ing3 = st.sidebar.number_input("Nilai Bahasa Inggris Semester 2.1", 68.0, 98.0)
        ing4 = st.sidebar.number_input("Nilai Bahasa Inggris Semester 2.2", 68.0, 98.0)
